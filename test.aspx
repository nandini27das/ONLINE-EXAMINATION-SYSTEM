<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="test.aspx.cs" Inherits="ONEXSYS.test" %>
                            ...
                            <td>
                                ...
                                <table style="width: 100%;">
                                    ...
                                    <tr>
                                        ...
                                        <td style="float: right; background-color: yellow; color: black;"><b><span id="lbresult">&nbsp;&nbsp; </span>
                            ...
                            <td>
                                ...
                                <asp:GridView ID="grdquestions" runat="server" AutoGenerateColumns="false" OnRowDataBound="grdquestions_RowDataBound" DataKeyNames="id" Width="100%">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Go ANALYZE">
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <table class="tableclass" id='<%#Eval("id") %>'>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><b>Question <%#Eval("id") %> -: <%#Eval("ques") %></b>
                                                                        ...
                                                                        <table class="tblOptions">
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    ...
                                                                                    <asp:RadioButton ID="rdOption1" runat="server" Text='<%#Eval("opta") %>' GroupName='<%#Eval("id") %>' />
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    ...
                                                                                    <asp:RadioButton ID="rdOption2" runat="server" Text='<%#Eval("optb") %>' GroupName='<%#Eval("id") %>' />
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    ...
                                                                                    <asp:RadioButton ID="rdOption3" runat="server" Text='<%#Eval("optc") %>' GroupName='<%#Eval("id") %>' /></td>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    ...
                                                                                    <asp:RadioButton ID="rdOption4" runat="server" Text='<%#Eval("optd") %>' GroupName='<%#Eval("id") %>' /></td>
            ...
            <script>
                ...
                function Decrement() {
                    ...
                    if (secs !== -1) {
                        ...
                        window.location.href = "category.aspx?timeout=1"
                ...
                function CheckIfAllQuestionAnswerHasBeenSubmitted() {
                    ...
                    if (parseInt(flagtocheckcount) == parseInt(numItems)) {
                        ...
                        $("#btnSubmit").attr("disabled", "true"); //disable button if all questions answer has been given
